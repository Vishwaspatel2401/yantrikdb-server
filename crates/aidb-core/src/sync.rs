...
/// Bidirectional sync between two AIDB instances.
///
/// Algorithm:
...
pub fn sync_bidirectional(a: &AIDB, b: &AIDB) -> Result<SyncResult> {
...
mod tests {
    ...
    fn test_two_instances_converge() {
        let a = AIDB::new_with_actor(":memory:", 8, "device-A").unwrap();
